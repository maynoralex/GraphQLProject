    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);
          ...
          modelBuilder.Entity<Category>().HasData(
            ...
            var roundedDate = new DateTime(date.Year, date.Month, date.Day, date.Hour, 0, 0, DateTimeKind.Utc);
            var dates = new DateTime []{
                roundedDate.AddDays(7),
                roundedDate.AddDays(10),
                roundedDate.AddDays(14)
            };
            modelBuilder.Entity<Reservation>().HasData(
               new Reservation { Id = 1, CustomerName = "John Doe", Email = "johndoe@example.com", PhoneNumber = "555-123-4567", PartySize = 2, SpecialRequest = "No nuts in the dishes, please.", ReservationDate = dates[0] },
               new Reservation { Id = 2, CustomerName = "Jane Smith", Email = "janesmith@example.com", PhoneNumber = "555-987-6543", PartySize = 4, SpecialRequest = "Gluten-free options required.", ReservationDate = dates[1] },
               new Reservation { Id = 3, CustomerName = "Michael Johnson", Email = "michaeljohnson@example.com", PhoneNumber = "555-789-0123", PartySize = 6, SpecialRequest = "Celebrating a birthday.", ReservationDate = dates[2] }
           );
